...
import 'package:localization_tools/translator/compare.dart';
import 'package:localization_tools/translator/deepl.dart';
import 'package:localization_tools/utils/flatten.dart';
import 'package:localization_tools/translator/helpers.dart';
import 'package:localization_tools/translator/types.dart';
...
Future<void> generateTranslations(ArgResults args, String baseDir) async {
  if (args["base"] == null || args["compare"] == null) {
  ...
  final fullComparePath = path.join(baseDir, args["compare"] as String);
  ...
  if (continueTranslating()) {
    for (final langConfigEntry in config.lang.entries) {
      final outputPath = path.join(baseDir, langConfigEntry.value);
